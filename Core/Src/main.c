...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LCD_RST_Pin|LCD_DC_Pin|GT30_CS_Pin|LCD_BLK_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LCD_RST_Pin LCD_DC_Pin GT30_CS_Pin LCD_BLK_Pin */
  GPIO_InitStruct.Pin = LCD_RST_Pin|LCD_DC_Pin|GT30_CS_Pin|LCD_BLK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
